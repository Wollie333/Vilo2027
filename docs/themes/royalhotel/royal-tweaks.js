/* ============================================================
   ROYAL HOTEL — Tweaks panel (vanilla, host-protocol aware)
   ============================================================ */
(function () {
  "use strict";
  ...
  var OPTS = {
    theme: [
      { v: "lagoon", label: "Charcoal" },
      { v: "riviera", label: "Stone" },
      { v: "seaglass", label: "Sage" },
    ],
    font: [
      { v: "grotesk", label: "Archivo" },
      { v: "archivo", label: "Space Grotesk" },
    ],
    shape: [
