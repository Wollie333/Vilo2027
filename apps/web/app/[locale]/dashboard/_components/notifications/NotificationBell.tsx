...
function grantIdOf(n: AppNotification): string | null {
  if (n.kind !== "support_access_request") return null;
  const id = (n.payload as { grant_id?: unknown } | null)?.grant_id;
  return typeof id === "string" ? id : null;
}
...
export function NotificationBell() {
  ...
  const onItemClick = async (n: AppNotification) => {
    ...
    // Support-access requests open the decide-popup (Accept / Decline / Report).
