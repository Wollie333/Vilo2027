...
export default async function TransactionsPage() {
  ...
  // RLS (platform_ledger_own_read / vilo_invoices_own_read) scopes both reads to
  // the signed-in user — they only ever see their own purchases.
    ...
    <div className="space-y-5">
      <header>
        ...
        <p className="mt-1 text-sm text-brand-mute">
          Your payments for subscriptions and products, with downloadable
          invoices.
        </p>
      </header>
