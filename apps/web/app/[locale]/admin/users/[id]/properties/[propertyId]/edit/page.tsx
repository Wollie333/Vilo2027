...
import { Editor } from "@/app/[locale]/dashboard/properties/[id]/edit/Editor";
import { loadListingEditorData } from "@/app/[locale]/dashboard/properties/[id]/edit/editorData";
...
export default async function AdminEditListingPage({
  ...
  const data = await loadListingEditorData(service, params.propertyId);
  if (!data) notFound();
