    ...
    <div className="min-h-screen bg-gray-50 p-8">
      <div className="mx-auto max-w-4xl space-y-6">
        ...
        <div className="rounded-lg bg-white p-6 shadow">
          ...
          {hostError ? (
            <div className="text-red-600">
              Error: {JSON.stringify(hostError)}
            </div>
          ) : host ? (
            <div className="space-y-2 font-mono text-sm">
              <div>
              ...
              <div>
                <strong>Display Name:</strong> {host.display_name}
              </div>
            </div>
          ) : (
            <div className="text-red-600">
              ✗ No host account found for this user
            </div>
          )}
        </div>
        ...
        <div className="rounded-lg bg-blue-50 p-6">
          ...
          <ul className="list-disc space-y-1 pl-5 text-sm">
            <li>
              If env vars are missing: Add them in Vercel Settings → Environment
              Variables
            </li>
            ...
            <li>
              Once fixed, go to{" "}
              <a href="/dashboard/reports" className="text-blue-600 underline">
                /dashboard/reports
              </a>
            </li>
          </ul>
