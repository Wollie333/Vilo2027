...
// Public thank-you / resource page (/go/affiliate/thanks). Mirrors the host
// thanks page for the affiliate audience: partner walkthrough video + Partner
// Pack download, and a next-step CTA into the existing partner signup/join.
// Placeholder-safe when brochure/video aren't set yet.

export const dynamic = "force-dynamic";

export const metadata: Metadata = {
  title: "Wielo · Your Partner Pack is ready",
  robots: { index: false, follow: false },
};

const INCLUDED = [
  "Your personal referral link + how it tracks",
  "Banners and social copy that convert",
  "Commission & payout guide (paid in rand)",
];

export default async function AffiliateThanksPage() {
      ...
      <section className="bg-brand-dark px-6 pb-24 pt-11 text-center">
        <div className="mx-auto max-w-[1060px]">
          ...
          <h1 className="mx-auto mt-4 max-w-[20ch] font-display text-[32px] font-extrabold leading-[1.08] tracking-[-0.02em] text-white md:text-[42px]">
            Your Partner Pack is ready.
          </h1>
          <p className="mx-auto mt-3.5 max-w-[56ch] text-[16.5px] leading-relaxed text-[#C7E4D7]">
            Watch the 2-minute walkthrough, then download the pack.{" "}
      ...
      <div className="mx-auto max-w-[1060px] px-6">
          ...
          <div className="overflow-hidden rounded-card border border-brand-line bg-white shadow-[0_10px_34px_-14px_rgba(6,78,59,0.18)]">
            {embed ? (
              <div className="aspect-video w-full bg-black">
                <iframe
                  src={embed}
                  title="Wielo partner walkthrough"
            ...
            <div className="flex flex-wrap items-start justify-between gap-4 p-5">
              <div>
                ...
                <p className="mt-1 text-[13.5px] leading-relaxed text-brand-mute">
                  How the partner programme works: your link, how commission
                  accrues, and the fastest way to your first referral.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="rounded-card border border-brand-line bg-white p-[22px] shadow-[0_10px_34px_-14px_rgba(6,78,59,0.18)]">
            <div className="flex items-center gap-3.5">
              ...
              <div>
                ...
                <p className="mt-1 text-[12.5px] text-brand-mute">
                  {funnel.brochure_name || "Referral guide (PDF)"}
                </p>
              </div>
            </div>
            ...
            {brochureUrl ? (
              ...
              <p className="mt-[18px] rounded-[10px] border border-dashed border-brand-line bg-brand-light py-3 text-center text-[13px] text-brand-mute">
                Your pack is on its way to your inbox.
              </p>
            )}
        ...
        <div className="mt-[22px] grid items-center gap-5 rounded-card border border-brand-line bg-white p-[22px] shadow-[0_1px_2px_rgba(6,78,59,0.05)] md:grid-cols-[1fr_auto]">
          <div>
            ...
            <p className="mt-1 text-[13.5px] leading-relaxed text-brand-mute">
              Activate your partner account to get your referral link and live
              earnings dashboard. Free to join, paid in rand, no minimums.
            </p>
          </div>
          <a
            href="/signup/partner"
