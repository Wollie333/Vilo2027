            ...
            content={({ active, payload }) => {
              ...
              return (
                <div style={{ fontSize: "11px" }}>
                  ...
                  <div style={{ color: "#fff" }}>R {formatCurrency(data.value)}</div>
                  <div style={{ color: "#9DC1B0", fontSize: "10px", marginTop: "2px" }}>
          ...
          <div key={item.channel} className="flex items-center justify-between text-xs">
            <div className="flex items-center gap-2">
              <div
                ...
                style={{
                  backgroundColor:
                    CHANNEL_COLORS[item.channel.toLowerCase()] || CHANNEL_COLORS.other,
                }}
              />
...
function formatChannelName(channel: string): string {
  ...
  return nameMap[formatted] || channel.charAt(0).toUpperCase() + channel.slice(1);
}
