...
import { Banknote, Gauge, Tag, BedDouble, TrendingUp, TrendingDown } from "lucide-react";
  ...
  return (
    <section className="grid grid-cols-1 gap-3 sm:grid-cols-2 lg:gap-4 xl:grid-cols-4">
      ...
      <div className="rounded-card border border-brand-line bg-white p-5">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <span className="text-xs font-medium text-brand-mute">Total revenue</span>
          </div>
      ...
      <div className="rounded-card border border-brand-line bg-white p-5">
        ...
        <div className="mt-1 text-xs text-brand-mute">Revenue per available night</div>
      </div>
      ...
      <div className="rounded-card border border-brand-line bg-white p-5">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <span className="text-xs font-medium text-brand-mute">Occupancy</span>
          </div>
          <span
            className={`inline-flex items-center gap-1 rounded-full px-2 py-0.5 text-xs font-medium ${
