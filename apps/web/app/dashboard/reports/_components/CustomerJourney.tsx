...
export function CustomerJourney({ data }: CustomerJourneyProps) {
  ...
  const breakdownItems = [
    ...
    { label: "3-7 days", value: data.breakdown.three_to_seven, color: "#F59E0B" },
    { label: "7-14 days", value: data.breakdown.seven_to_fourteen, color: "#EF4444" },
    { label: "14+ days", value: data.breakdown.over_fourteen, color: "#6B7280" },
  ];
