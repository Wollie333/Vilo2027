...
/**
 * Oceans View bespoke FOOTER — the founder's reference footer ported class-by-
 * class (scoped `.ovchrome`). A dark-navy band: brand + blurb, an "Explore" link
 * column from the live menu, a "Stay" column (book + contact), a newsletter/keep-
 * in-touch column, then a legal row with a Powered-by-Wielo mark and social
 * icons. Wired to the site's live brand + menu. Pure presentational (server).
 */
export function OceansViewFooter({
  brand,
  menu,
  bookHref,
  bookLabel,
      ...
      <footer className="footer">
        <div className="wrap">
          <div className="foot-top">
            ...
            <div>
              <div className="foot-h">Keep in touch</div>
              <p className="foot-blurb" style={{ marginTop: 0 }}>
                Open dates, seasonal offers and a real person on the other end.
                No spam, ever.
              </p>
              <a
                href={contactHref}
                className="btn btn-coral btn-sm foot-cta"
