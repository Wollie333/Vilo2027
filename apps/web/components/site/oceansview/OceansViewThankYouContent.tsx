...
export interface OceansViewThankYouEft {
...
export interface OceansViewThankYouProps {
  ...
  nights?: number | null;
  total?: string | null;
  eft?: OceansViewThankYouEft | null;
  message?: string | null;
  eyebrow?: string | null;
...
const COPY = {
  confirmed: {
    ...
    lead: "A confirmation is on its way to your inbox. We can't wait to welcome you to the bay.",
  },
  eft: {
  ...
  form: {
    ...
    lead: "We've got your message and a real person on the bay will reply soon.",
  },
} as const;
...
export function OceansViewThankYouContent({
  state,
  firstName,
  reference,
  checkIn,
