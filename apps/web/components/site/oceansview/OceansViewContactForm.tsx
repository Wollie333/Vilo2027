...
import type { OceansViewCtx } from "./OceansViewSections";
...
/**
 * The Oceans View ("oceansview" theme) contact band — a REAL lead-capture form.
 ...
 * submit. Styling stays scoped to `.wielo-oceansview` (.cgrid / .dcard / .drow /
 * .field / .frow), driven by `--site-*`.
 */
export function OceansViewContactForm({
  props,
  ctx,
  websiteId,
  interactive = false,
