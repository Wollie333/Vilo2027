 ...
 * (`.rrooms` / royalRooms.css, forked from the OceansView rooms layout then given
 * a grand-hotel treatment: a centred formal page-head + a champagne rule under
 * each room name; palette/type via the `.wielo-royal` skin). Wired to the host's
 * LIVE rooms (`rooms_preview`) — alternating image/detail splits with a floating
 * price badge, live facts, real book/view links; demo placeholder when empty.
 * Renders inside the shared themed chrome. Part of Phase B (theme differentiation).
 */
