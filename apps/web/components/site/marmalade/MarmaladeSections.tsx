...
import { MarmaladeBookingSearch } from "./MarmaladeBookingSearch";
import { MarmaladeSearchResults } from "./MarmaladeSearchResults";

/**
 * The Marmalade House ("marmalade" theme) bands — the SAME flat sections the
 * builder knows, rendered in the warm postcard-album guesthouse design. The
 * SectionRenderer dispatches here (via `renderMarmaladeSection`) when the active
 * theme is marmalade, so the builder canvas and the public site render
 ...
 * Every selector lives in marmalade.css under `.wielo-marmalade` (--site-*).
 */
...
const IMG = {
  hero: "https://images.unsplash.com/photo-1505691938895-1758d7feb511?w=2400&q=80",
  intro:
    "https://images.unsplash.com/photo-1505693416388-ac5ce068fe85?w=1200&q=80",
  room1: "https://images.unsplash.com/photo-1560185007-cde436f6a4d0?w=900&q=80",
  room2:
    "https://images.unsplash.com/photo-1566195992011-5f6b21e539aa?w=900&q=80",
  room3:
    "https://images.unsplash.com/photo-1566195992011-5f6b21e539aa?w=900&q=80",
  g1: "https://images.unsplash.com/photo-1522708323590-d24dbb6b0267?w=1200&q=80",
  g2: "https://images.unsplash.com/photo-1470337458703-46ad1756a187?w=700&q=80",
  g3: "https://images.unsplash.com/photo-1505691938895-1758d7feb511?w=700&q=80",
  g4: "https://images.unsplash.com/photo-1416879595882-3373a0480b5b?w=700&q=80",
  g5: "https://images.unsplash.com/photo-1502602898657-3e91760cbb34?w=700&q=80",
  g6: "https://images.unsplash.com/photo-1466692476868-aef1dfb1e735?w=1200&q=80",
  g7: "https://images.unsplash.com/photo-1522708323590-d24dbb6b0267?w=700&q=80",
...
const STOCK_ROOMS = [
  {
    tag: "Garden-facing",
    name: "The Fig Room",
    meta: ["Sleeps 2", "Claw-foot bath", "King bed"],
    desc: "Our sunniest room, opening onto the old fig tree. A deep bath and birdsong for an alarm.",
    price: "R1,450",
    img: IMG.room1,
  },
  {
    ...
    meta: ["Sleeps 2", "Own entrance", "Queen bed"],
    desc: "A room of one's own, with a stoep onto the garden and a door you can leave open all night.",
    price: "R1,650",
    img: IMG.room2,
  },
  {
    ...
    meta: ["Sleeps 4", "Sitting room", "Wide stoep"],
    desc: "Our biggest — a bedroom, a sitting room and a wide stoep. Room for the children and the dog.",
    price: "R2,300",
    img: IMG.room3,
  },
];
...
const STOCK_REVIEWS = [
  {
    quote:
      "The nicest place we've ever stayed — like visiting the friend you wish you had.",
    initials: "EM",
    name: "Ella & Marcus",
    loc: "Apr 2026 · Cape Town",
  },
  {
    quote:
      "I'd book it for the breakfast alone. The fig jam should be illegal. Already rebooked the Fig Room.",
    initials: "TP",
    name: "Thandi P.",
    loc: "Mar 2026 · Joburg",
  },
  {
    quote:
      "Quiet, kind, and full of small lovely touches. The kind of place that ruins ordinary hotels for you.",
    initials: "JK",
    name: "Jan K.",
    loc: "Feb 2026 · Amsterdam",
  },
];
...
const STOCK_POSTS = [
  {
    title: "The fig jam that named the house",
    href: "#",
    excerpt:
      "It started with a tree we couldn't keep up with and a glut of figs. Hannah's recipe, finally written down.",
    coverUrl: IMG.g1,
    date: "Jun 2026",
  },
  {
    title: "What's growing in June",
    href: "#",
    excerpt:
      "A wander through the winter garden — what's ready, and what we're doing with it.",
    coverUrl: IMG.g3,
    date: "May 2026",
  },
  {
    title: "A beginner's guide to the Karoo sky",
    href: "#",
    excerpt:
      "Pieter's stoep-side guide to the brightest things overhead after dark.",
    coverUrl: IMG.g5,
    date: "Apr 2026",
  },
];
    ...
    <section className="hero" data-section="hero">
      ...
      <div className="hero-in">
        <div className="wrap">
          ...
          <h1>{props.headline || "A little house that feeds you well."}</h1>
...
/* ── INTRO / STORY ──────────────────────────────────────────────────── */
export function MarmaladeIntro({
  props,
  asset,
  ctx,
}: {
  ...
  const heading = props.heading || "A home with spare rooms";
...
export function MarmaladeHighlights({
  props,
  asset,
}: {
  props: P<"highlights">;
...
/* ── STATS ──────────────────────────────────────────────────────────── */
export function MarmaladeStats({ props }: { props: P<"stats"> }) {
      ...
      <div className="wrap">
        ...
        >
          <div style={{ maxWidth: 560 }}>
            ...
            <h2 className="lg" style={{ marginTop: 12 }}>
              {props.heading || "Pick a room, any room"}
            </h2>
          </div>
  ...
  return (
    <section className="section sand" data-section="gallery" data-live="true">
      <div className="wrap">
        <div className="sec-head center">
          {props.eyebrow ? <span className="tag">{props.eyebrow}</span> : null}
          <h2 className="lg">{props.heading || "The house, in snapshots"}</h2>
        </div>
...
/* ── REVIEWS (navy band) ────────────────────────────────────────────── */
export function MarmaladeReviews({
  props,
  data,
}: {
  props: P<"reviews">;
...
/* ── LOCATION (copy + map) ──────────────────────────────────────────── */
export function MarmaladeLocation({
  props,
  ctx,
}: {
  props: P<"location">;
      ...
      <div className="wrap">
        <div className="cgrid">
          <div>
            ...
            <h2 className="lg" style={{ marginTop: 12 }}>
              {props.heading || "Finding us"}
            </h2>
            <p className="muted" style={{ marginTop: 18, maxWidth: "46ch" }}>
              {props.body ||
                "A two-minute walk from the village's best dinner. We'll send a map and our favourites when you book."}
            </p>
            {ctx?.contactHref ? (
              <a
...
/* ── MAP ────────────────────────────────────────────────────────────── */
export function MarmaladeMap({ props }: { props: P<"map"> }) {
        ...
        <div className="wrap">
          <div className="banner">
            ...
            <div className="banner-in">
              <h2>{props.heading || "Notes from the kitchen"}</h2>
              <p>
                {props.body ||
    ...
    <section className="section" data-section="cta">
      <div className="wrap">
        <div className="banner">
          ...
          <img src={img(props.image_path, asset, IMG.hero)} alt="" />
          <div className="banner-in">
            <h2>{props.heading || "Come stay a night or three"}</h2>
            <p>
              {props.body ||
...
/* ── HOST BIO ───────────────────────────────────────────────────────── */
export function MarmaladeHostBio({
  props,
  asset,
}: {
  props: P<"host_bio">;
...
/* ── VALUES ─────────────────────────────────────────────────────────── */
export function MarmaladeValues({ props }: { props: P<"values"> }) {
...
/* ── FAQ (accordion) ────────────────────────────────────────────────── */
export function MarmaladeFaq({ props }: { props: P<"faq"> }) {
...
/* ── AMENITIES ──────────────────────────────────────────────────────── */
export function MarmaladeAmenities({ props }: { props: P<"amenities"> }) {
...
/* ── PRICING / RATES ────────────────────────────────────────────────── */
export function MarmaladePricing({ props }: { props: P<"pricing"> }) {
...
export function MarmaladeSpecials({ data }: { data?: SpecialsPreviewData }) {
...
/* ── BLOG PREVIEW ───────────────────────────────────────────────────── */
export function MarmaladeBlogPreview({
  props,
  data,
}: {
...
/* ── ROOM DETAIL bands ──────────────────────────────────────────────── */
function MarmaladeRoomPlaceholder({ label }: { label: string }) {
  return (
...
export function MarmaladeRoomGallery({
  props,
  data,
}: {
  ...
  if (!images.length)
    return <MarmaladeRoomPlaceholder label="This room's photos appear here." />;
...
export function MarmaladeRoomOverview({
  props,
  data,
}: {
  ...
  if (!data)
    return (
      <MarmaladeRoomPlaceholder label="The room's name and details appear here." />
    );
    ...
    <div data-section="room_overview" data-live="true">
      ...
      {data.description ? (
        ...
        <p className="lead" style={{ maxWidth: "60ch" }}>
          A sunny room with space to slow down — a deep bath, good books, and
          birdsong for an alarm.
        </p>
      )}
    </div>
  );
...
export function MarmaladeRoomAmenities({
  props,
  data,
}: {
  ...
  if (!amenities.length)
    return (
      <MarmaladeRoomPlaceholder label="This room's amenities appear here." />
    );
...
export function MarmaladeRoomRate({
  props,
  data,
}: {
  props: P<"room_rate">;
  ...
  if (!data)
    return (
      <MarmaladeRoomPlaceholder label="The room's rate and booking button appear here." />
    );
...
export function MarmaladeRoomPolicies({
  props,
  data,
}: {
  ...
  if (!p)
    return (
      <MarmaladeRoomPlaceholder label="This room's cancellation policy and house rules appear here." />
    );
  return <MarmaladePolicyView heading={props.heading} policies={p} inline />;
}

export function MarmaladePolicies({
  props,
  data,
}: {
  props: P<"policies">;
  ...
  if (!data) return null;
  return <MarmaladePolicyView heading={props.heading} policies={data} />;
}

/* ── RATE TABLE ─────────────────────────────────────────────────────── */
export function MarmaladeRateTable({
  props,
  data,
}: {
  props: P<"rate_table">;
...
/* ── GENERIC FALLBACK ───────────────────────────────────────────────── */
function renderMarmaladeGenericFallback(
...
export function renderMarmaladeSection(
  section: WebsiteSection,
  opts: {
    data?: SiteData;
    asset?: SiteAssetResolver;
  ...
  switch (section.type) {
    case "hero":
      return <MarmaladeHero props={section.props} asset={asset} ctx={ctx} />;
    case "intro":
      return <MarmaladeIntro props={section.props} asset={asset} ctx={ctx} />;
    case "highlights":
      return <MarmaladeHighlights props={section.props} asset={asset} />;
    case "rooms_preview":
      return (
        <MarmaladeRooms
          props={section.props}
    ...
    case "location":
      return <MarmaladeLocation props={section.props} ctx={ctx} />;
    case "cta":
      return <MarmaladeCta props={section.props} asset={asset} ctx={ctx} />;
    case "host_bio":
      return <MarmaladeHostBio props={section.props} asset={asset} />;
    case "stats":
      return <MarmaladeStats props={section.props} />;
    case "values":
      return <MarmaladeValues props={section.props} />;
    case "map":
      return <MarmaladeMap props={section.props} />;
    case "contact_form":
      return (
    ...
    case "faq":
      return <MarmaladeFaq props={section.props} />;
    case "amenities":
      return <MarmaladeAmenities props={section.props} />;
    case "pricing":
      return <MarmaladePricing props={section.props} />;
    case "blog_preview":
      return (
        <MarmaladeBlogPreview
          props={section.props}
...
export function MarmaladeSectionList({
  sections,
  data,
  asset,
  ctx,
  ...
  const render = (s: WebsiteSection) => {
    const ov = renderMarmaladeSection(s, {
      data,
      asset,
      ctx,
      websiteId,
    ...
    return renderMarmaladeGenericFallback(s, { data, asset, interactive });
  };
  return (
    <>
      {sections
