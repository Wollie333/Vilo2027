...
export interface MarmaladeThankYouEft {
...
export interface MarmaladeThankYouProps {
...
const COPY = {
  confirmed: {
    ...
    lead: "A confirmation is on its way to your inbox. We'll have the kettle on and your room ready.",
  },
  eft: {
    eyebrow: "Awaiting your transfer",
    heading: () => "Almost there",
    lead: "Your booking is reserved. Make the transfer below using your reference and we'll confirm once it reflects.",
  },
  processing: {
  ...
  form: {
    ...
    lead: "We've got your message and a real person at the house will reply within a day.",
  },
} as const;
...
export function MarmaladeThankYouContent({
  state,
  firstName,
  reference,
  checkIn,
      ...
      <div className="wrap wrap-read">
        <div
          style={{
            ...
            textAlign: "center",
            boxShadow: "0 30px 60px -40px rgba(10,34,48,.3)",
          }}
        >
          <div
            style={{
              ...
              color: "var(--site-accent-deep, var(--site-accent))",
              display: "flex",
              alignItems: "center",
          ...
          <h1 className="lg" style={{ marginTop: 10 }}>
            {heading}
          </h1>
          <p
            className="muted"
            style={{ marginTop: 14, maxWidth: "46ch", marginInline: "auto" }}
          >
            {lead}
          </p>
          {reference ? (
          ...
          >
            <a href={homeHref} className="btn btn-coral btn-lg">
              <span>Back to home</span>
            </a>
            {roomsHref ? (
              <a href={roomsHref} className="btn btn-ghost btn-lg">
                <span>Browse the rooms</span>
              </a>
            ) : null}
          </div>
          {isBooking ? (
