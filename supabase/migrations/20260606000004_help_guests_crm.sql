-- Migration: Help Centre article for the Guests (CRM) feature. Idempotent on slug.
...
<h3>Add a guest</h3>
<p>Use <strong>Add guest</strong> to save a contact who hasn&rsquo;t booked yet. Email is required (it&rsquo;s how guests are matched). Tick the consent box if you have permission to email them &mdash; that&rsquo;s required before they can receive broadcasts (POPIA).</p>
