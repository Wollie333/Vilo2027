-- Migration: upgrade the account-wide Ledger help article to the rich,
-- design-system layout — real KPI cards, coloured Type/For pills, a live
-- mini-ledger, check-mark lists, an animated progress bar, an action grid and
-- audit/periods callouts. Styling lives in apps/web/app/help/help-article.css
-- (scoped under .help-article); the sanitiser now keeps class/div/span.
-- Idempotent on slug — refreshes the row created in 20260608000004.
