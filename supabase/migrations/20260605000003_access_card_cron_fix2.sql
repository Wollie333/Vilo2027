-- Fix: check_in_time lives on listings, not bookings — the due-window WHERE
-- clause must use l.check_in_time. Redefine send_due_access_cards() with that
-- correction; body otherwise unchanged.
